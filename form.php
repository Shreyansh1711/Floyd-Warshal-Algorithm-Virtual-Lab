...
<form action="FloydWarshalVlab.php" method="post" target="_blank">
<h1>Implementation using Floyd Warshall Algorithm</h1>
<h2>If infinite then enter value as 999</h2>
...
<tr>
<td>1</td>
<td><input type="number" name="val[0][0]" size="4" value = 0></td> 
<td><input type="number" name="val[0][1]" size="4" value = 0></td>
<td><input type="number" name="val[0][2]" size="4" value = 0></td>
<td><input type="number" name="val[0][3]" size="4" value = 0></td>
</tr>
<tr>
<td>2</td>
<td><input type="number" name="val[1][0]" size="4" value = 0></td> 
<td><input type="number" name="val[1][1]" size="4" value = 0></td>
<td><input type="number" name="val[1][2]" size="4" value = 0></td>
<td><input type="number" name="val[1][3]" size="4" value = 0></td>
</tr>  
<tr>
<td>3</td>
<td><input type="number" name="val[2][0]" size="4" value = 0></td> 
<td><input type="number" name="val[2][1]" size="4" value = 0></td>
<td><input type="number" name="val[2][2]" size="4" value = 0></td>
<td><input type="number" name="val[2][3]" size="4" value = 0></td>
</tr> 
<tr>
<td>4</td>
<td><input type="number" name="val[3][0]" size="4" value = 0></td> 
<td><input type="number" name="val[3][1]" size="4" value = 0></td>
<td><input type="number" name="val[3][2]" size="4" value = 0></td>
<td><input type="number" name="val[3][3]" size="4" value = 0></td>
</tr> 
</table>
...
$flag = array();
$dist = array();
$arr = array(array(0, 100, 40, 10), array(999, 0, 5, 9), array(21, 20, 0, 0), array(34, 46, 0, 0));
$n = 4;
...
<script language='javascript'>
		...
		if(dist[2][3] != 0 && dist[2][3] != 999 && flag[2][3] != 1)
		{
			ctx.beginPath();
			ctx.moveTo(145,380);
			ctx.lineTo(355,380);
		...
		if(dist[3][2] != 0 && dist[3][2] != 999 && flag[3][2] != 1)
		{
			ctx.beginPath();
			ctx.moveTo(355,420);
			ctx.lineTo(145,420);
		...
		if(dist[3][1] != 0 && dist[3][1] != 999 && flag[3][1] != 1)
		{
			ctx.beginPath();
			ctx.moveTo(380,355);
			ctx.lineTo(380,145);
		...
		if(dist[1][3] != 0 && dist[1][3] != 999 && flag[1][3] != 1) 
		{
			ctx.beginPath();
			ctx.moveTo(420,145);
			ctx.lineTo(420,355);
		...
		if(dist[0][3] != 0 && dist[0][3] != 999 && flag[0][3] != 1)
		{
			ctx.beginPath();
			ctx.moveTo(140,130);
			ctx.lineTo(370,360);
		...
		if(dist[3][0] != 0 && dist[3][0] != 999 && flag[3][0] != 1)
		{
			ctx.beginPath();
			ctx.moveTo(360,375);
			ctx.lineTo(128,143);
